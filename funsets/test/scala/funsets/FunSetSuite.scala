...
class FunSetSuite extends FunSuite {
  ...
  ignore("union contains all elements") {
    ...
    new TestIntersect{
      val intersectOfSingleton = intersect(s1, s2)
      ...
      assert(!contains(intersectOfUnions, 3), "Intersect of union sets 3")
    ...
    new TestDiff{
      ...
      assert(!contains(diffOfUnions, 3), "Diff of union sets 3")
